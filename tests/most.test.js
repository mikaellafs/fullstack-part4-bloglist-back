...
describe('most likes', () =>{
    test('when blogs list is empty', () =>{
        const zero = []
        const result = listHelper.mostLikes(zero)
        expect(result).toEqual(null)
    })
